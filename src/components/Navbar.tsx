...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-[hsl(222,47%,8%/0.82)] backdrop-blur-xl after:absolute after:bottom-0 after:left-0 after:right-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-primary/40 after:to-transparent"
    >
